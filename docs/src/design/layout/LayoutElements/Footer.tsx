...
export default function Footer() {
  return (
    <footer className="container m-auto mt-4 max-w-7xl px-4 pb-8">
      <div className="rounded-lg border border-violet-200 bg-violet-100 p-8 dark:border-violet-900 dark:bg-violet-950">
