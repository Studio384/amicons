...
export default function IconCard({ icon }: { icon: ILibraryIcon }) {
  return (
    <NavLink
      to={`/icons/${icon.slug}`}
      className="relative flex flex-col items-center justify-center gap-3 rounded-md bg-neutral-100 p-4 text-black focus-within:bg-indigo-200 focus-within:text-indigo-700 hover:bg-indigo-200 hover:text-indigo-700"
    >
